...
<div class="col-lg-10 col-12 px-4">
    ...
    <div class="mx-5">
      ...
      <form action="/admin/editvoucher" method="post">
        @csrf
              ...
              <div class="row my-2">
                ...
                <div class="col-9">
                  <input type="text" name="code_voucher" class="form-control" placeholder="Nhập mã giảm giá" value="{{ $voucher->code_voucher }}">
              ...
              <div class="row my-2">
                ...
                <div class="col-9">
                  <select name="type_discount" id="" class="form-select"  value="{{ $voucher->type_discount }}">
                    <option {{ $voucher->type_discount==1?'selected':'' }} value="1">Giảm theo số tiền</option>
                    <option {{ $voucher->type_discount==2?'selected':'' }} value="2">Giảm theo phần trăm</option>
                  </select>
                </div>
              </div>
              <div class="row my-2">
                ...
                <div class="col-9">
                  <input type="text" name="discount" class="form-control" placeholder="Nhập giá trị giảm giá" value="{{ $voucher->discount }}">
              ...
              <div class="row my-2">
                ...
                <div class="col-9">
                  <input type="text" name="miximum_payment" class="form-control" placeholder="Nhập giá trị đơn hàng tối thiểu" value="{{ $voucher->miximum_payment }}">
              ...
              <div class="row my-2">
                ...
                <div class="col-9">
                  <input type="text" name="id_user" class="form-control" placeholder="Nhập id khách hàng áp dụng" value="{{ $voucher->id_user }}">
              ...
              <div class="row my-2">
                ...
                <div class="col-9">
                  <input type="text" name="quantity" class="form-control" placeholder="Nhập số lượng" value="{{ $voucher->quantity }}">
